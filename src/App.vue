  ...
  <div id="app">
    <link rel="stylesheet"
      ...
      <div id="page-container">
        <header>
          <span id='myName'>
          <router-link to="/" exact> <span id='myName2'> Antoine Brault </span> </router-link> <hr>
          </span>
          <div id='allNavMobile'>
          ...
          <nav>
          <ul>
            <li><router-link to="/publications"> Publications </router-link><hr> </li>
            <!-- <span v-if='linkActive'><hr></span> -->
            <li><router-link to="/talks">Talks </router-link> <hr></li>
            <li><router-link to="/teaching" >Teaching </router-link><hr></li>
            <li><router-link to="/cv" >CV </router-link><hr></li>
          </ul>
          </nav>
          </div>
        </transition>
...
a + hr{
 ...
 a:hover + hr, a.router-link-exact-active + hr{
  display: block;
  height:3px;
  margin: 0;
  margin-top:4px;
